...
function supprimer_article($ref){
mysql_query("DELETE FROM article where ref_article=$ref;") or die(mysql_error());
...
supprimer_article($_POST['num_ref']);
...
<table>
<tr>
  <td><label style="color:white;">Refference de article</label></td>
