...
function supprimer_d_agent($ref){
mysql_query("DELETE FROM agent where id_agent=$ref;") or die(mysql_error());
...
supprimer_d_agent($_POST['num_agent']);
...
<table>
<tr>
  <td><label style="color:white;">id agent :</label></td>
